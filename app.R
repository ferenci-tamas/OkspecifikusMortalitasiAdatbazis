...
server <- function(input, output) {
  ...
  dataInputTime <- reactive(dataInputFun(
    ...
    multipleICD = input$timeMultipleICD,
    ICDSingle = switch(input$timeCategory, "Groups" = input$timeGroupsICDSingle,
                       "Individual" = input$timeIndividualICDSingle,
                       "Avoidable" = input$timeAvoidableICDSingle),
    ICDMultiple = switch(input$timeCategory, "Groups" = input$timeGroupsICDMultiple,
                         "Individual" = input$timeIndividualICDMultiple,
                         "Avoidable" = input$timeAvoidableICDMultiple),
    multipleCountry = input$timeMultipleCountry,
    countrySingle = input$timeCountrySingle,
    countryMultiple = input$timeCountryMultiple,
    indicator = input$timeIndicator,
    yllMethod = input$timeYllMethod,
    yllPyllTarget = input$timeYllPyllTarget,
    strat = input$timeStratification,
  ...
  dataInputMap <- reactive(dataInputFun(
    ...
    multipleICD = "Single",
    ICDSingle = mapICDSingle(),
    ICDMultiple = NA,
    multipleCountry = NA,
    countrySingle = NA,
    countryMultiple = NA,
    indicator = input$mapIndicator,
    yllMethod = input$mapYllMethod,
    yllPyllTarget = input$mapYllPyllTarget,
    strat = NA,
  ...
  dataInputAgesex <- reactive(dataInputFun(
    ...
    yllMethod = NA,
    yllPyllTarget = NA,
    strat = input$agesexStratification,
    metric = "cruderate",
    ordVar = "AgeNum",
    byvarAdd = c("Age", "AgeNum", "AgeLabel", "CauseGroup"),
  ...
  dataInputHunworld <- reactive(dataInputFun(
    ...
    countrySingle = NA,
    countryMultiple = union(input$hunworldCountryInvestigated, input$hunworldCountryComparison),
    indicator = input$hunworldIndicator,
    yllMethod = input$hunworldYllMethod,
    yllPyllTarget = input$hunworldYllPyllTarget,
    strat = NA,
    metric = "adjrate",
    ordVar = NA,
    byvarAdd = "CauseGroup",
    yearFilter = input$hunworldYear,
    sexFilter = "Összesen",
    ageFilter = "Összesen",
    comp = input$hunworldCountryInvestigated,
    valid = FALSE))
  ...
  dataInputHconv <- reactive(dataInputFun(
    ...
    multipleCountry = "Multiple",
    countrySingle = NA,
    countryMultiple = union(input$hconvCountryInvestigated, input$hconvCountryComparison),
    indicator = input$hconvIndicator,
    yllMethod = input$hconvYllMethod,
    yllPyllTarget = input$hconvYllPyllTarget,
    strat = NA,
  ...
  dataInputHconvdecomp <- reactive(dataInputFun(
    ...
    multipleICD = "MultiIndiv",
    ICDSingle = NA,
    ICDMultiple = names(ICDGroups$Groups)[c(2, 9, 32, 33, 34, 37, 42, 46, 53, 60, 65, 66, 69, 72, 73, 74, 75, 79, 83)],
    multipleCountry = "Multiple",
    countrySingle = NA,
    countryMultiple = union(input$hconvdecompCountryInvestigated, input$hconvdecompCountryComparison),
    indicator = input$hconvdecompIndicator,
    yllMethod = input$hconvdecompYllMethod,
    yllPyllTarget = input$hconvdecompYllPyllTarget,
    strat = NA,
    metric = "adjrate",
    ordVar = "EurostatCode",
